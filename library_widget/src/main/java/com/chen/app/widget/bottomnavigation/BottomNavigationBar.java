package com.chen.app.widget.bottomnavigation;
...
import com.chen.app.widget.R;
import com.chen.app.widget.bottomnavigation.behaviour.BottomNavBarFabBehaviour;
import com.chen.app.widget.bottomnavigation.behaviour.BottomVerticalScrollBehavior;
import com.chen.app.widget.bottomnavigation.utils.Utils;
...
//    }
    ...
    public void initialise() {
        ...
        if (!mBottomNavigationItems.isEmpty()) {
            ...
            if (mBackgroundStyle == BACKGROUND_STYLE_DEFAULT) {
                if (mMode == MODE_FIXED || mMode == MODE_FIXED_ORIGIN_ICON) {
                    mBackgroundStyle = BACKGROUND_STYLE_STATIC;
                } else {
                    mBackgroundStyle = BACKGROUND_STYLE_RIPPLE;
                }
            ...
            if (mMode == MODE_FIXED || mMode == MODE_FIXED_NO_TITLE || mMode == MODE_FIXED_ORIGIN_ICON) {
    ...
    private void setUpTab(boolean isNoTitleMode, BottomNavigationTab bottomNavigationTab, BottomNavigationItem currentItem, int itemWidth, int itemActiveWidth) {
        ...
        bottomNavigationTab.initialise(mBackgroundStyle == BACKGROUND_STYLE_STATIC, mMode == MODE_FIXED_ORIGIN_ICON);
