...
public final class ToastUtils {
    ...
    public final ToastUtils setLeftIcon(@DrawableRes int resId) {
        return setLeftIcon(ContextCompat.getDrawable(AppUtils.getApp(), resId));
    }
    ...
    public final ToastUtils setTopIcon(@DrawableRes int resId) {
        return setTopIcon(ContextCompat.getDrawable(AppUtils.getApp(), resId));
    }
    ...
    public final ToastUtils setRightIcon(@DrawableRes int resId) {
        return setRightIcon(ContextCompat.getDrawable(AppUtils.getApp(), resId));
    }
    ...
    public final ToastUtils setBottomIcon(int resId) {
        return setBottomIcon(ContextCompat.getDrawable(AppUtils.getApp(), resId));
    }
    ...
    private View tryApplyUtilsToastView(final CharSequence text) {
        ...
        View toastView = UtilsBridge.layoutId2View(R.layout.toast_view);
    ...
    public static final class UtilsMaxWidthRelativeLayout extends RelativeLayout {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int widthMaxSpec = MeasureSpec.makeMeasureSpec(UtilsBridge.getScreenWidth() - SPACING, MeasureSpec.AT_MOST);
